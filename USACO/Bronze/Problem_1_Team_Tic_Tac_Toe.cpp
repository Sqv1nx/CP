...
void solve()
{
    ...
    set<char> a1;
    set<set<char>> a2;
    vector<set<char>> cases(8);
    cases[0] = {s[0][0], s[0][1], s[0][2]};
    cases[1] = {s[1][0], s[1][1], s[1][2]};
    cases[2] = {s[2][0], s[2][1], s[2][2]};
    cases[3] = {s[0][0], s[1][0], s[2][0]};
    cases[4] = {s[0][1], s[1][1], s[2][1]};
    cases[5] = {s[0][2], s[1][2], s[2][2]};
    cases[6] = {s[0][0], s[1][1], s[2][2]};
    cases[7] = {s[0][2], s[1][1], s[2][0]};
    for (auto c : cases)
    {
        if (c.size() == 1)
        {
