...
void solve()
{
    ...
    while (i < n)
    {
        ...
        {
            extra = extra + game[i].c + game[i].d;
        }
        else if (game[i].a == 'x' && game[i].b == 'x')
        {
            if (game[i].c > game[i].d)
            {
                l1 += extra;
                extra = l1 * (game[i].c - 1) + l2 * (game[i].d - 1);
            }
            else if (game[i].c < game[i].d)
            {
                l2 += extra;
                extra = l1 * (game[i].c - 1) + l2 * (game[i].d - 1);
            }
            else
            {
                ...
                while (k < n)
                {
                    if (game[k].a == '+' && game[k].b == '+')
                        k++;
                    else if (game[k].a == 'x' && game[k].b == 'x')
                    {
                        if (game[k].c > game[k].d)
                        {
                            l1 += extra;
                            break;
                        }
                        else if (game[k].c < game[k].d)
                        {
                            l2 += extra;
                            break;
                        }
        ...
        else
        {
            ...
            {
                l1 += extra;
                extra = l1 * (game[i].c - 1) + game[i].d;
            }
            else if (game[i].b == 'x')
            {
                l2 += extra;
                extra = l2 * (game[i].d - 1) + game[i].c;
            }
        }
        i++;
    }
